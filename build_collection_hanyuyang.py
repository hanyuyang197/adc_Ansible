#!/usr/bin/env python3
"""
构建Ansible集合包的脚本 - 用于hanyuyang197命名空间
"""
...
def create_collection_structure():
    ...
    # 如果存在adc_common.py则复制
    adc_common_path = library_dir / "adc_common.py"
    if adc_common_path.exists():
        shutil.copy2(adc_common_path, module_utils_dest)
    else:
        # 如果不存在，创建一个基础的adc_common.py
        adc_common_content = '''"""
ADC通用函数模块
"""
import json
...
def create_manifest_json(collection_dir):
    ...
    manifest_content = {
        "collection_info": {
            ...
            "dependencies": {},
            "repository": "https://github.com/hanyuyang197/horizon-modules",
            "documentation": "https://github.com/hanyuyang197/horizon-modules/blob/main/README.md",
            "homepage": "https://github.com/hanyuyang197/horizon-modules",
            "issues": "https://github.com/hanyuyang197/horizon-modules/issues"
        },
        "file_manifest_file": {
            "name": "FILES.json",
            "ftype": "file",
...
def build_collection_package(collection_dir, build_dir):
    ...
    # 创建tar.gz包
    package_name = "hanyuyang197-modules-1.0.0.tar.gz"
