...
def main():
    ...
    if action == 'list_profiles':
        result = adc_list_http2_profiles(module)
    elif action == 'list_profiles_withcommon':
        result = adc_list_http2_profiles_withcommon(module)
    elif action == 'get_profile':
        result = adc_get_http2_profile(module)
    elif action == 'add_profile':
        result = adc_add_http2_profile(module)
    elif action == 'edit_profile':
        result = adc_edit_http2_profile(module)
    elif action == 'delete_profile':
        result = adc_delete_http2_profile(module)
    else:
