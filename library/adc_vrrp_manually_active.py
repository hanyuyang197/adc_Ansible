...
def main():
    ...
    module_args = dict(
        ...
        action=dict(type='str', required=True, choices=['vrrp_manually_active_set', 'vrrp_manually_inactive_set']),
    ...
    # 执行操作
    if action == 'vrrp_manually_active_set':
        vrrp_manually_active_set(module)
    elif action == 'vrrp_manually_inactive_set':
