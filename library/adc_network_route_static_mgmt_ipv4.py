...
def route_static_mgmt_ipv4_list(module):
    """获取IPv4静态管理路由列表"""
    ip = module.params['ip']
...
def route_static_mgmt_ipv4_get(module):
    """获取IPv4静态管理路由详情"""
    ip = module.params['ip']
    authkey = module.params['authkey']
...
def route_static_mgmt_ipv4_add(module):
    """添加IPv4静态管理路由"""
    ip = module.params['ip']
    authkey = module.params['authkey']
    destination = module.params['destination'] if 'destination' in module.params else ""
...
def route_static_mgmt_ipv4_edit(module):
    """编辑IPv4静态管理路由"""
    ip = module.params['ip']
    authkey = module.params['authkey']
    destination = module.params['destination'] if 'destination' in module.params else ""
...
def main():
    ...
    if action == 'route_static_mgmt_ipv4_list':
        route_static_mgmt_ipv4_list(module)
    elif action == 'route_static_mgmt_ipv4_get':
        route_static_mgmt_ipv4_get(module)
    elif action == 'route_static_mgmt_ipv4_add':
