...
def slb_va_vs_stat_count_list(module):
    """获取虚拟服务状态汇总"""
    ip = module.params['ip']
    authkey = module.params['authkey']
...
def main():
    ...
    module_args = dict(
        ...
        action=dict(type='str', required=True, choices=[
                    ...
                    'slb_va_vs_stat_get', 'slb_va_vs_stat_count_list']),
        # 虚拟服务参数
    ...
    elif action == 'slb_va_vs_stat_get':
        slb_va_vs_stat_get(module)
    elif action == 'slb_va_vs_stat_count_list':
        slb_va_vs_stat_count_list(module)
