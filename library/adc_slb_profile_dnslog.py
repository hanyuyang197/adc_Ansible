...
def adc_list_dnslog_profiles(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.dnslog.list" % (ip, authkey)
...
def adc_list_dnslog_profiles_withcommon(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.dnslog.list.withcommon" % (ip, authkey)
...
def adc_get_dnslog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.dnslog.get" % (ip, authkey)
...
def adc_add_dnslog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.dnslog.add" % (ip, authkey)
...
def adc_edit_dnslog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.dnslog.edit" % (ip, authkey)
...
def adc_delete_dnslog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.dnslog.del" % (ip, authkey)
