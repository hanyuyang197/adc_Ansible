...
def define_module_args():
    return dict(
        ...
        header_trans_list=dict(type='list', required=False, elements='dict'),
        sdp_dnat_pool=dict(type='str', required=False),
        sdp_snat_pool=dict(type='str', required=False),
        client_request_header_add_list=dict(type='list', required=False, elements='dict'),
        client_response_header_add_list=dict(type='list', required=False, elements='dict'),
        server_request_header_add_list=dict(type='list', required=False, elements='dict'),
        server_response_header_add_list=dict(type='list', required=False, elements='dict'),
        client_request_header_del_list=dict(type='list', required=False, elements='dict'),
        client_response_header_del_list=dict(type='list', required=False, elements='dict'),
        server_request_header_del_list=dict(type='list', required=False, elements='dict'),
        server_response_header_del_list=dict(type='list', required=False, elements='dict'),
        modify_header_list=dict(type='list', required=False, elements='dict'),
