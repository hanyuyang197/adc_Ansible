...
def adc_list_sip_profiles(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.sip.list" % (ip, authkey)
...
def adc_list_sip_profiles_withcommon(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.sip.list.withcommon" % (ip, authkey)
...
def adc_get_sip_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.sip.get" % (ip, authkey)
...
def adc_add_sip_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.sip.add" % (ip, authkey)
...
def adc_edit_sip_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.sip.edit" % (ip, authkey)
...
def adc_delete_sip_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.sip.del" % (ip, authkey)
