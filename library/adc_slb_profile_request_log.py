...
def slb_profile_request_log_list(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.request_log.list" % (
        ip, authkey)
...
def slb_profile_request_log_list_withcommon(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.request_log.list.withcommon" % (
        ip, authkey)
...
def slb_profile_request_log_get(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.request_log.get" % (
        ip, authkey)
...
def slb_profile_request_log_add(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.request_log.add" % (
        ip, authkey)
...
def slb_profile_request_log_edit(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.request_log.edit" % (
        ip, authkey)
...
def slb_profile_request_log_del(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.request_log.del" % (
        ip, authkey)
