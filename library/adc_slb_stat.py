...
def adc_list_slb_states(module):
    """获取SLB状态列表"""
    ip = module.params['ip']
    ...
    try:
        ...
        module.fail_json(msg="获取SLB状态列表失败: %s" % str(e))
...
def adc_clear_slb_session(module):
    """清除SLB会话"""
    ip = module.params['ip']
    authkey = module.params['authkey']
    ...
    try:
        ...
        module.fail_json(msg="清除SLB会话失败: %s" % str(e))
...
def main():
    ...
    module_args = dict(
        ...
        action=dict(type='str', required=True, choices=[
            'list_slb_states', 'clear_slb_session'])
    )
