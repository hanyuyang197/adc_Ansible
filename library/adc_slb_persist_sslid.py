...
def adc_list_sslid_profiles(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.persist.sslid.list" % (ip, authkey)
...
def adc_list_sslid_profiles_withcommon(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.persist.sslid.list.withcommon" % (ip, authkey)
...
def adc_get_sslid_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.persist.sslid.get" % (ip, authkey)
...
def adc_add_sslid_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.persist.sslid.add" % (ip, authkey)
...
def adc_edit_sslid_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.persist.sslid.edit" % (ip, authkey)
...
def adc_delete_sslid_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.persist.sslid.del" % (ip, authkey)
