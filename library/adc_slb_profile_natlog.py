...
def adc_list_natlog_profiles(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.natlog.list" % (
        ip, authkey)
...
def adc_list_natlog_profiles_withcommon(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.natlog.list.withcommon" % (
        ip, authkey)
...
def adc_get_natlog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.natlog.get" % (
        ip, authkey)
...
def adc_add_natlog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.natlog.add" % (
        ip, authkey)
...
def adc_edit_natlog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.natlog.edit" % (
        ip, authkey)
...
def adc_delete_natlog_profile(module):
    ...
    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=slb.profile.natlog.del" % (
        ip, authkey)
