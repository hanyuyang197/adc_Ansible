...
def acl_ipv4_ext_item_add(module):
    """添加IPv4扩展访问列表条目"""
    ip = module.params['ip']
    authkey = module.params['authkey']
    id = module.params['id'] if 'id' in module.params else ""
...
def acl_ipv4_ext_item_edit(module):
    """编辑IPv4扩展访问列表条目"""
    ip = module.params['ip']
    authkey = module.params['authkey']
    id = module.params['id'] if 'id' in module.params else ""
...
def acl_ipv4_ext_item_del(module):
    """删除IPv4扩展访问列表条目"""
    ip = module.params['ip']
    authkey = module.params['authkey']
    id = module.params['id'] if 'id' in module.params else ""
...
def acl_ipv4_ext_desc_set(module):
    """设置IPv4扩展访问列表描述"""
    ip = module.params['ip']
    authkey = module.params['authkey']
    id = module.params['id'] if 'id' in module.params else ""
...
def main():
    ...
    module_args = dict(
        ...
        action=dict(type='str', required=True, choices=[
            'acl_ipv4_ext_list', 'acl_ipv4_ext_get', 'acl_ipv4_ext_item_add', 'acl_ipv4_ext_item_edit', 'acl_ipv4_ext_item_del', 'acl_ipv4_ext_desc_set']),
        # ACL参数
    ...
    if action == 'acl_ipv4_ext_list':
        acl_ipv4_ext_list(module)
    elif action == 'acl_ipv4_ext_get':
        acl_ipv4_ext_get(module)
    elif action == 'acl_ipv4_ext_item_add':
        acl_ipv4_ext_item_add(module)
    elif action == 'acl_ipv4_ext_item_edit':
        acl_ipv4_ext_item_edit(module)
    elif action == 'acl_ipv4_ext_item_del':
        acl_ipv4_ext_item_del(module)
    elif action == 'acl_ipv4_ext_desc_set':
        acl_ipv4_ext_desc_set(module)
