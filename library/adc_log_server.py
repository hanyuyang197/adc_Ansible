...
def adc_log_server_download(module):
    """下载业务日志"""
    ip = module.params['ip']
    authkey = module.params['authkey']

    # 构造请求URL
    url = "http://%s/adcapi/v2.0/?authkey=%s&action=log.server.download" % (ip, authkey)
...
def main():
    ...
    # 执行操作
    adc_log_server_download(module)
